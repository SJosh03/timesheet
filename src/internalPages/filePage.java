 ...
 * @author SCC-MIKE
 */
public class filePage extends javax.swing.JInternalFrame {
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT * FROM tbl_file");
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        ...
        if(rowIndex < 0){
            ...
            if(a == JOptionPane.YES_OPTION){
                ...
                dbc.deleteData(s_id, "tbl_file", "file_id");
                displayData();
            }
        }
