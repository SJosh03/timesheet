 ...
 * @author SCC-MIKE
 */
public class approvementsPage extends javax.swing.JInternalFrame {

    /**
     * Creates new form userPage
     */
    public approvementsPage() {
        initComponents();
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT tbl_user.user_id,"
                    + "tbl_user.user_Firstname,"
                    + "tbl_user.user_Lastname,"
                    + "tbl_file.file_name "
                    + "FROM tbl_applicant "
                    + "LEFT JOIN tbl_user ON tbl_applicant.user_id=tbl_user.user_id "
                    + "LEFT JOIN tbl_file ON tbl_applicant.file_id=tbl_file.file_id");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APPROVEMENTS PAGE");
        jPanel2.add(jLabel1);
