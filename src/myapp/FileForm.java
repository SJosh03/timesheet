...
public class FileForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("File Position:");
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
       if(action.equals("Add")){
           ...
           int check = validateRegister();
                if(check == 1){
                    dbConnector dbc = new dbConnector();
                        int result = dbc.insertData("INSERT INTO tbl_file (file_name, file_position) "
           ...
           dbConnector dbc = new dbConnector();
           dbc.updateData("UPDATE tbl_file SET file_name = '"+dept_code.getText()+"', file_position = '"+dept_desc.getText()+"' WHERE file_id  = '"+dept_id.getText()+"'");
           close();
       }else{
